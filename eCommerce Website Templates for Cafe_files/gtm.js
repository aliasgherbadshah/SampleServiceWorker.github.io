...
var xc={},yc=null,zc=Math.random();xc.i="GTM-PFK425";xc.xb="7f1";var Ac={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0},Cc="www.googletagmanager.com/gtm.js";var Dc=Cc,Ec=null,Fc=null,Gc=null,Hc="//www.googletagmanager.com/a?id="+xc.i+"&cv=53",Ic={},Jc={},Kc=function(){var a=yc.sequence||0;yc.sequence=a+1;return a};var G=function(a,b,c,d){return(2===Lc()||d||"http:"!=u.location.protocol?a:b)+c},Lc=function(){var a=Qa(),b;if(1===a)a:{var c=Dc;c=c.toLowerCase();for(var d="https://"+c,e="http://"+c,g=1,h=A.getElementsByTagName("script"),k=0;k<h.length&&100>k;k++){var l=h[k].src;if(l){l=l.toLowerCase();if(0===l.indexOf(e)){b=3;break a}1===g&&0===l.indexOf(d)&&(g=2)}}b=g}else b=a;return b};var Mc=!1;
...
Z.a.f=["google"],function(){(function(a){Z.__f=a;Z.__f.b="f";Z.__f.g=!0;Z.__f.priorityOverride=0})(function(a){var b=hi("gtm.referrer",1)||A.referrer;return b?a.vtp_component&&"URL"!=a.vtp_component?ib(jb(String(b)),a.vtp_component,a.vtp_stripWww,a.vtp_defaultPages,a.vtp_queryKey):fi(String(b)):String(b)})}();Z.a.k=["google"],function(){(function(a){Z.__k=a;Z.__k.b="k";Z.__k.g=!0;Z.__k.priorityOverride=0})(function(a){return ki(a.vtp_name,hi("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
P);}else if("TRACK_SOCIAL"==c.vtp_trackType){}else if("TRACK_TRANSACTION"==c.vtp_trackType){
w("require","ecommerce","//www.google-analytics.com/plugins/ua/ecommerce.js");var R=function(V){return hi("transaction"+V,1)},T=R("Id");w("ecommerce:addTransaction",{id:T,affiliation:R("Affiliation"),revenue:R("Total"),shipping:R("Shipping"),tax:R("Tax")});for(var O=R("Products")||[],M=0;M<O.length;M++){var I=O[M];w("ecommerce:addItem",{id:T,sku:I.sku,name:I.name,category:I.category,price:I.price,quantity:I.quantity})}w("ecommerce:send");}else if("TRACK_TIMING"==
